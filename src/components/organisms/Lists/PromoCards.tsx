...
const PromoCards = ({ data, deleteItem, setDataList }: CardsInterface) => {
        ...
        <>
            {openModal && (
                <DeleteModal
                    ...
                    string={string}
                    text={string?.do_you_want_to_delete_promo_label}
                    action={() =>
                        ...
                        <Grid xs={sx ? 12 : 2} sx={{ ml: 'auto', p: 1, borderTop: sx ? '1px solid #ccc' : '' }}>
                            ...
                            >
                                <IconButton
                                    ...
                                    size="small"
                                    onClick={() => {
                                        navigate(`/store-inventory/${storeCode}/options/promos/${item?.id}/edit`);
                                    }}
                                >
