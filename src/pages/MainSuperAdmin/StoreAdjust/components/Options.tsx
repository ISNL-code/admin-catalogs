        ...
        <>
            <Grid container xs={12} sx={{ border: '1px solid #ccc', p: 1 }}>
                ...
                <Grid container xs={sx ? 12 : 6}>
                    <Grid xs={12} sx={{ px: 1 }}>
                        <FormControlLabel control={<Checkbox defaultChecked />} label={string?.cart} />
                    </Grid>
                    <Grid xs={12} sx={{ px: 1 }}>
                        <FormControlLabel control={<Checkbox defaultChecked />} label={string?.favorites} />
                    </Grid>
                    <Grid xs={12} sx={{ px: 1 }}>
                        <FormControlLabel control={<Checkbox defaultChecked />} label={string?.contacts} />
                    </Grid>
                    <Grid xs={12} sx={{ px: 1 }}>
                ...
                <Grid container xs={sx ? 12 : 6}>
                    <Grid xs={12} sx={{ px: 1 }}>
                        <FormControlLabel control={<Checkbox defaultChecked />} label={string?.search_by_sku} />
                    </Grid>
                    <Grid xs={12} sx={{ px: 1 }}>
                        <FormControlLabel control={<Checkbox defaultChecked />} label={string?.prices} />
                    </Grid>
                    <Grid xs={12} sx={{ px: 1 }}>
                ...
                <Grid container xs={sx ? 12 : 6}>
                    <Grid xs={sx ? 12 : 4} sx={{ p: 1, py: 1.25 }}>
                        <FormControlLabel control={<Checkbox defaultChecked />} label={string?.private_store} />
                    </Grid>
